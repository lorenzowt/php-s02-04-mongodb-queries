...
- 🧪 **Query**: `db.restaurants.find({grades: {$elemMatch: {grade: "A", score: 11, date: ISODate("2014-08-11T00:00:00.000Z")}}}, {_id: 0, restaurant_id: 1, name: 1, grades: 1})`
- ⏱️ **Execution time**: 1 ms
- 📚 **Documents returned**: 1
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: PROJECTION_SIMPLE
...
- 🧪 **Query**: `db.restaurants.find({"location.coordinates": {$elemMatch: {$type: "double" }}}, {_id: 0, name: 1, restaurant_id: 1, "location.coordinates": 1})`
- ⏱️ **Execution time**: 1 ms
- 📚 **Documents returned**: 664
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: PROJECTION_DEFAULT
...
- 🧪 **Query**: `db.restaurants.find({name: {$regex: "mon", $options: "i"}}, {_id:0, name: 1, borough: 1, cuisine: 1, "location.coordinates": 1})`
- ⏱️ **Execution time**: 1 ms
